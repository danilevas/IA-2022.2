...
class MiniMaxPlayer:
    ...
    def minimaxno2 (self, board, moves, curDepth, no_atual, maxTurn, targetDepth):
        ...
        if (maxTurn == True):
            ...
            for move in moves:
                ...
                filho = No(move, h)
                ab = self.minimaxno2(board, moves, curDepth + 1, filho, False, targetDepth).ab
                filho.ab = ab
    ...
    def escolha2(self, board, moves):
        ...
        return self.minimaxno2(board, moves, 0, no_raiz, True, 5).move
